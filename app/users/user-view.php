...
if ($currentRole === 'user') {
    ...
    <style>
        ...
        /* ===== Info rows (replaces the plain <table> look) =====
           Label on the left, value on the right - overrides the site's
           default blue th styling by not using <table>/<th> at all. */
        .info-rows {
            display: flex;
        ...
        /* ===== Edit button: compact, never stretches =====
           ...
           since a global "button { width: 100% }" rule elsewhere on the
           site keeps overriding class-based rules. */
        #editBtn {
        ...
        /* ===== Close (x) button =====
           ...
           stretching the close button into a full-width green bar even
           with #id + !important overrides, because it's still an element
           the global "button" selector matches. Using a span instead means
           no "button { }" rule anywhere on the site can ever touch it. */
        #closeBtn {
    ...
    <div class="account-header">
        ...
        <a class="account-back" href="<?php echo BASE_URL; ?>/app/user/dashboard.php">
        ...
        <div class="card-columns">
            ...
            <div class="card-box">
                ...
                <div style="display: flex; justify-content: flex-end; margin-top: 14px;">
                    <button type="button" id="editBtn" class="edit-icon-btn" onclick="openEditModal()" style="display:inline-flex!important;width:100px!important;max-width:100px!important;min-width:0!important;flex:none!important;align-items:center!important;justify-content:center!important;gap:4px!important;background:#fff!important;border:1px solid #cfd8e3!important;border-radius:8px!important;padding:6px 12px!important;font-size:13px!important;color:#274b81!important;cursor:pointer!important;white-space:nowrap!important;margin:0!important;box-shadow:none!important;text-transform:none!important;">
                ...
                <?php if ($user['membership_id']): ?>
                    ...
                    <div class="info-rows">
                        ...
                        <div class="info-row">
                            ...
                            <span class="info-value"><?php echo htmlspecialchars($user['livestock_details']); ?></span>
                        </div>
                        <?php endif; ?>
                        <?php if (!empty($user['crops_details'])): ?>
                        <div class="info-row">
                            <span class="info-label">Crops Grown</span>
                            <span class="info-value"><?php echo htmlspecialchars($user['crops_details']); ?></span>
                        </div>
                        <?php endif; ?>
                    </div>
                <?php else: ?>
...
// ============================================================
// ADMIN / MANAGER - listing table (unchanged)
// ============================================================
