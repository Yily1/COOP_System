...
// SECURITY: this page can reset every password in the system and log
// you in as any user with one click. It was previously reachable by
// anyone, logged in or not. Restrict it to admins only, and make sure
// to delete this whole tests/ folder before going to production.
requireRole('admin');
