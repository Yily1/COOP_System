...
// SECURITY: this page can switch your session into ANY user's account
// with a single click, including admins. It was previously reachable
// by anyone, logged in or not. Restrict it to admins only, and make
// sure to delete this whole tests/ folder before going to production.
requireRole('admin');
